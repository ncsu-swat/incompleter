...
class ZillowScraper():
        ...
        def fetch(self, url, params):
                ...
                response = _c_(545894, _a_(545890, _n_(545889, "requests", lambda: requests), "get"), _n_(545891, "url", lambda: url), headers=_n_(545892, "self", lambda: self), params=_n_(545893, "params", lambda: params))
                _l_(545895)
                _c_(545898, _n_(545896, "print", lambda: print), _n_(545897, "response", lambda: response))
                _l_(545899)
                aux = _n_(545900, "response", lambda: response)
                _l_(545901)
                return aux
        ...
        def run(self):
                ...
                res = _c_(545909, _a_(545906, _n_(545905, "self", lambda: self), "fetch"), _n_(545907, "url", lambda: url), _n_(545908, "params", lambda: params))
                _l_(545910)

if _n_(545913, "__name__", lambda: __name__) == '__main__':
        _l_(545921)

        scraper = _c_(545915, _n_(545914, "ZillowScraper", lambda: ZillowScraper))
        _l_(545916)
        _c_(545919, _a_(545918, _n_(545917, "scraper", lambda: scraper), "run"))
        _l_(545920)