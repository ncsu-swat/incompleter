...
class Network(_a_(654281, _n_(654280, "base_layer", lambda: base_layer), "Layer")):
  _l_(654289)
  ...
  _TF_MODULE_IGNORED_PROPERTIES = _c_(654287, _n_(654282, "frozenset", lambda: frozenset), _c_(654286, _a_(654283, itertools, "chain"), ('_layer_call_argspecs', '_compiled_trainable_state'),
      _a_(654285, _a_(654284, base_layer, "Layer"), "_TF_MODULE_IGNORED_PROPERTIES")
  ))
  _l_(654288)