...
class Widget(QWidget):
    def __init__(self):
        ...
        with open('aib_october.csv', encoding= 'utf-8-sig') as f:
    ...
    def export_data(self):
        with open("aib_october.csv", 'w', newline='') as file:
                writer = csv.DictWriter(file,fieldnames=self._data.keys())
                writer.writeheader()
    ...
    def add_element(self):
        ...
        try:
            ...
            self.items += 1
            self._data.update(self.description.text())
            self._data.update(self.price.text())
            print(self._data)
        except ValueError:
    ...
    def plot_data(self):
        ...
        for i in range(self.table.rowCount()):
            ...
            number = float(self.table.item(i, 1).int())
    ...
    def fill_table(self, data=None):
        ...
        for desc, price in data.items():
            ...
            self.table.setItem(self.items, 1, price_item)
            self.items += 1
            self._data = self._data.update({desc: price})
            print(self._data)
